...
public class LxWebView extends WebView {
    ...
    public void setOnWebViewStateListener(WebViewStateListener webViewStateListener) {
    ...
    private class WebServiceChromeClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int progress) {
            ...
            webViewStateListener.onProgressChanged(view, progress);
        }
    ...
    private class WebServiceViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if (state == WebViewState.STOP) {
                ...
                if (webViewStateListener != null) {
                    webViewStateListener.onStartLoading(url, favicon);
                }
            }
        }
        ...
        public void onReceivedError(WebView view, int errorCode, String description,
            ...
            if (webViewStateListener != null) {
                webViewStateListener.onError(errorCode, description, failingUrl);
            }
        }
        ...
        public void onPageFinished(WebView view, String loadedUrl) {
            ...
            if (state == WebViewState.START) {
                if (webViewStateListener != null) {
                    webViewStateListener.onProgressChanged(view, 100);
                    webViewStateListener.onFinishLoaded(loadedUrl);
                }
            }
